...
#if macro
import typing.definition.Definition;
import typing.definition.DVariable;
import typing.definition.DParameter;
import typing.definition.DFunction;
import typing.definition.DType;
import typing.definition.DArg;
